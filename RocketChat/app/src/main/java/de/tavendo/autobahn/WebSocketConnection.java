...
public class WebSocketConnection implements WebSocket {
    ...
    protected boolean scheduleReconnect() {
        ...
        boolean shouldReconnect = mActive
                && isConnected()
                && mPreviousConnection
                && (interval > 0);
        if (shouldReconnect) {
    ...
    private void handleMessage(Message message) {
        ...
        if (message.obj instanceof WebSocketMessage.TextMessage) {
            ...
            final WebSocketCloseNotification closeCode = (close.getCode() == WebSocketCloseCode.NORMAL) ? WebSocketCloseNotification.NORMAL : WebSocketCloseNotification.CONNECTION_LOST;
            ...
            onClose(closeCode, close.getReason());
    ...
    public static class SocketThread extends Thread {
        ...
        public void startConnection() {
            try {
                ...
                this.mSocket.connect(new InetSocketAddress(host, port), mWebSocketOptions.getSocketConnectTimeout());
                this.mSocket.setSoTimeout(mWebSocketOptions.getSocketReceiveTimeout());
                this.mSocket.setTcpNoDelay(mWebSocketOptions.getTcpNoDelay());
