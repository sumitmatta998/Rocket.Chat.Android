...
public class RocketMethods {
    ...
    public void uploadFile(String userId, String rid, String name, String[] strings, String type, String extension, long size, FileUploadListener listener) {
        String store = "rocketchat_uploads";
        //TODO: What is this id?
        String id = "some id that I need to figure out";
        ...
        ResultListener ufsCompletelistener = new ResultListener() {
            @Override
            public void onSuccess(String result) {
                //TODO: understand how to properly create this msg
                String msg = "File Uploaded: " + name + " https://" + BuildConfig.WS_HOST + "ufs/rocketchat_uploads/" + id + extension;
                Map<String, Object> data = new HashMap<>();
