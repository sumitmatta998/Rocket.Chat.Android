...
public class DBContentProvider extends ContentProvider {
    ...
    //TODO sumit
    public static final String APPLICATION_ID ="videocall.sumit.com.videocalling";
    private static final String AUTHORITY = APPLICATION_ID + ".provider/";
    ...
    public String getType(Uri uri) {
        ...
        if (LinkfiedTextView.sUrlMatcher.matcher(path).matches()) {
            return "vnd.android.cursor.item/vnd." + APPLICATION_ID + ".provider.text_html";
        }
        if (LinkfiedTextView.sUsernameMatcher.matcher(path).matches()) {
            return "vnd.android.cursor.item/vnd." + APPLICATION_ID + ".provider.user_name";
        }
