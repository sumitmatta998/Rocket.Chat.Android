...
public class RocketApp extends Application implements Persistence {
    ...
    public static final String ACTION_DISCONNECTED = APPLICATION_ID + ".METEOR.DISCONNECTED";
    public static final String ACTION_CONNECTED = APPLICATION_ID + ".METEOR.CONNECTED";
